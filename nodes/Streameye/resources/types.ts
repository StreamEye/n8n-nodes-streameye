...
export type JsonParameterParser = (
	value: unknown,
...
export const isValidatedOperation = (op: ResourceOperation): op is ValidatedResourceOperation =>
	typeof (op as ValidatedResourceOperation).validate === 'function';
